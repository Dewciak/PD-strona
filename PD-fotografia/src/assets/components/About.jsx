  ...
  return (
    <div className="max-w-[1050px] h-auto md:h-screen mx-auto md:mt-8 overflow-hidden">
      <div className="w-full text-center">
        <h1 className="text-5xl mt-12 md:mt-0">Profesjonalna</h1>
        <h2 className="text-2xl py-4 text-gray-500">Fotografia Zwierząt</h2>
      </div>
      <div className="w-full flex flex-col-reverse md:flex-row justify-center items-center md:mt-6 ">
        <div className="flex flex-col md:w-[45%] pl-4">
          <h1
            data-aos="slide-up"
            className="text-4xl pb-8 font-bold bg-gradient-to-r from-blue-500 to-purple-500 inline-block text-transparent md:mt-0 bg-clip-text mt-8 text-center md:text-left mx-6 "
          >
            Poznaj mnie!
          </h1>

          <p1 data-aos="slide-up" className="px-6">
