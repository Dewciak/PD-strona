...
function About() {
  return (
    <>
      <div
        id="About"
        className="max-w-[1050px] h-auto  mx-auto md:pt-24 overflow-hidden  shadow-[#0000000d]"
      >
        ...
        <div className="w-full flex flex-col-reverse md:flex-row justify-center items-center md:mt-6 ">
          <div className="flex flex-col md:w-[45%] pl-4">
            ...
            <p data-aos="slide-right" className="px-6 tracking-[2px]">
              Cześć, jestem Patrycja Dawid. Fotografuję zwierzęta od 2014 roku.
              Dorastałam z psami i końmi, co pozwala mi świetnie porozumieć się
              z Waszymi pupilami i uchwycić je w migawce aparatu. W wolnym
              czasie lubię jeździć konno, uprawiam agility i uwielbiam spacery
              po lesie.
            </p>
          </div>
          {/* zdjęcie about */}
          <div data-aos="slide-left" className="md:ml-auto mx-auto ">
            <img
              src={AboutImage}
              className=" md:w-[500px] w-[95%] mx-auto"
            ></img>
          </div>
        </div>
