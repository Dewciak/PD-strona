import About from "../../images/Dogs/About.webp";
...
export const headerContent = {
  aboutImage: About,
  mainHeader: "Fotografia Psów",
  mainHeaderDescription: `Zapraszam Ciebie i Twojego czworonożnego przyjaciela na wyjątkową sesję zdjęciową`,
  secondHeader:
    "Jeśli marzysz o pamiątce na długie lata to trafiłeś w dobre ręce. ",
  secondHeaderDescription: `Podczas tworzenia zdjęć każdy szczegół jest dla mnie ważny,
  ...
  aboutText2: "i dobre samopoczucie Twojego psa jest dla mnie priorytetem.",
  aboutHeader3: "Niezwykłe wspomnienia",
  aboutText3: `które zapewnia sesja zdjęciowa to nie tylko okazja do
