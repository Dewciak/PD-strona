...
export function UnderlineTabs() {
  ...
  const data = [
    ...
    },
    {
      ...
      desc5: `8 zdjęć - 350 zł`,
      desc6: `Mozliwość dokupienia pojedynczego ujecia w cenie 40 zł`,
    },
    {
      label: "Treningowa",
      value: "Treningowa",
  ...
  return (
    <Tabs value={activeTab}>
      <TabsHeader
        className=" border-b max-w-[95%] md:max-w-[80%] mx-auto border-blue-gray-50 bg-transparent py-1 rounded-[12px] z-[1]  bg-gradient-to-r from-blue-100 to-[#EBDFFA]"
        indicatorProps={{
          className:
      ...
      >
        {data.map(({ label, value }) => (
          <Tab
            ...
            className={
              activeTab === value
                ? "text-gray-900 text-sm md:text-xl"
                : "md:text-xl text-sm"
            }
          >
            {label}
      ...
      >
        ...
        {data.map(({ value, desc, desc2, desc3, desc4, desc5, desc6 }) => (
          <TabPanel
            key={value}
            value={value}
            className="rounded-[20px] mt-16  w-[100%] flex flex-row space-x-6  pb-10"
          >
            <div className="w-[33%] px-6 mx-auto shadow-lg rounded-[20px] flex flex-col justify-center items-center hover:scale-105 duration-500 cursor-default">
            ...
            {/* drugi pakiet */}
            <div className="w-[33%] px-6 mx-auto shadow-lg rounded-[20px] flex flex-col justify-center items-center hover:scale-105 duration-500 cursor-defaultr">
              <h1 className="pt-20 pb-14 text-center text-3xl font-semibold">
                Pakiet 2
              </h1>
