  ...
  return (
    <div className='flex flex-col overflow-hidden'>
      <div className='w-screen flex flex-row text-center bg-gray-200 py-1'>
        <div className='md:w-[1080px]  mx-auto flex md:flex-row flex-col  text-sm md:items-start items-center justify-center'>
          <RouterLink
            to='/Regulamin-Sesji'
            onClick={() => {
              window.scrollTo(0, 0);
          ...
          >
            <span className='hover:text-gray-500 tracking-[5px] text-center font-light text-titleGray'>
              Regulamin Sesji
            </span>
          </RouterLink>
          <RouterLink
            ...
            className='  md:w-[50%]  h-full'
          >
            <span className='hover:text-gray-500 tracking-[5px] font-light text-titleGray text-center'>
      ...
      <div className='w-screen py-8 bg-gray-100 mx-auto flex flex-col justify-evenly  items-center'>
        <div className='md:w-[1080px] h-auto flex md:flex-row flex-col justify-center items-center md:justify-around mx-auto space-y-4 md:space-y-0  md:items-start'>
          ...
          <div className='w-[33%] h-full  flex flex-row justify-center items-center gap-x-2'>
            ...
            <a href='https://www.facebook.com/patrycjadawidfotografia?locale=pl_PL' target='blank'>
              <FaFacebook className='text-white text-3xl' />
            </a>
            <a href='https://www.instagram.com/patrycjadfotografia/' target='blank'>
