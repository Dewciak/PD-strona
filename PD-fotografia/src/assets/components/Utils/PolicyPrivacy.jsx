...
function PolicyPrivacy() {
  return (
    <div id="PolitykaPrywatności" className="Bg flex flex-col w-screen">
      {/*  */}
      <Navbar />
      ...
      <div className="flex flex-col w-[92%] space-y-12 mx-auto max-w-[1080px] pt-16 mt h-auto justify-center items-center mb-32">
        <div class="p-4 tracking-[0px] font-[Lora] text-myGray font-normal text-[17px] leading-[34px] whitespace-pre-line">
          ...
          <p>
            ...
            <br />
            <br />
            3. Dane osobowe zbierane za pośrednictwem Serwisu są przetwarzane
            ...
            <br />
            <br />
            5. Szanuje prawo do prywatności i dbam o bezpieczeństwo danych. W
          ...
          <br />
          <p>
            Usługodawca jest administratorem danych swoich klientów. Jeżeli
            skontaktowałeś się ze mną poprzez moją stronę, to przetwarzam Twoje
            dane jak: imię, nazwisko, adres e-mail, numer telefonu oraz inne
            podane w formularzu kontaktowym lub poprzez e-mail.
            <br />
            ...
            <br />
            <br />
            3. Podanie danych jest dobrowolne, ale niezbędne do skorzystania z
          ...
          <h1 class="text-2xl font-bold text-center py-10">
            §.4 Prawa Użytkowników
          </h1>
          <p>
            1. Użytkownik Strony ma prawo do:
            <br />
            - dostępu do treści swoich danych osobowych, a także ich
            sprostowania, usunięcia, ograniczenia przetwarzania, przenoszenia,
            wniesienia sprzeciwu wobec przetwarzania, cofnięcia zgody w każdej
            chwili (co nie ma wpływu na zgodność z prawem przetwarzania
            ...
            <br />
            <br />
            3. Administrator wykonuje lub odmawia spełnienia żądania
            niezwłocznie – maksymalnie w ciągu miesiąca od jego otrzymania.
            <br />
            <br />
            4. Użytkownik ma prawo złożyć skargę do Prezesa Urzędu Ochrony
            Danych Osobowych, jeśli uzna, że przetwarzanie narusza jego prawa i
            wolności (RODO). Każda osoba, której dane dotyczą ma prawo dostępu
            do tych danych, sprostowania, usunięcia lub ograniczenia ich
            przetwarzania, prawo sprzeciwu, oraz prawo wniesienia skargi do
            organu nadzorczego.
            <br />
            <br />
            Kontakt z osobą czuwającą nad przetwarzaniem danych osobowych na
            stronie Usługodawcy jest możliwy drogą elektroniczną pod adresem
            e-mail: patrycjad20@gmail.com.
            <br />
            <br />
            Zastrzegam sobie prawo do przetwarzania Twoich danych po rozwiązaniu
            ...
            unijne bądź prawa międzynarodowego obligują mnie do retencji danych.
            <br />
            <br />
            ...
            <br />
            <br />
            Dane osobowe przetwarzane będą w celu realizacji sesji
            fotograficznej wraz z obróbką zdjęć na podstawie art. 6 ust. 1 pkt b
            Rozporządzenie Parlamentu Europejskiego i Rady (UE) 2016/679 z dnia
            27 kwietnia 2016 r. w sprawie ochrony osób fizycznych w związku z
            przetwarzaniem danych osobowych i w sprawie swobodnego przepływu
            takich danych oraz uchylenia dyrektywy 95/46/WE i przechowywane do
            momentu wykonania ww. celu przetwarzania. Podanie danych osobowych
            jest dobrowolne, jednakże ich niepodanie uniemożliwi wykonanie
            umowy.
            <br />
            <br />
            ...
            <br />
            <br />
            W niektórych sytuacjach Usługodawca ma prawo przekazać Twoje dane
          ...
          <p>
            Witryna używa cookies. Są to niewielkie pliki tekstowe wysyłane
            ...
            witryna rozpoznaje rodzaj urządzenia, z którego łączy się
            ...
            korzystanie z odwiedzonych witryn.
            <br />
            <br />
            ...
            informacji przesyłanych do witryny za pomocą formularza
            kontaktowego.
            <br />
            <br />
            ...
            reklam. Stosujemy pliki cookies, aby zagwarantować najwyższy
            standard wygody naszego serwisu, a zebrane dane są wykorzystywane
            jedynie wewnątrz firmy Patrycja Dawid Fotografia w celu
            ...
            urządzenia w ustawieniach przeglądarki. Użytkownik w każdej chwili
            ma możliwość wyłączenia lub przywrócenia opcji gromadzenia cookies
            poprzez zmianę ustawień w przeglądarce internetowej. Instrukcja
          ...
          <p>
            1. Usługodawca ma prawo do wprowadzenia zmian w Polityce
            prywatności, przy czym prawa Użytkowników nie zostaną ograniczone.
            <br />
            2. Informacja o wprowadzonych zmianach pojawi się w formie
            informacji dostępnej w Serwisie.
            <br />
